...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
    <head>
        ...
        <meta property="og:image" content="/images/Botica/Logojerryml.png" />
        ...
        <header>
            <div class="container">
                <a href="<?php echo url_for('homepage')?>" id="logo">
                    <img src="/images/Botica/Logojerryml.png" alt="logo"/>
                </a>
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="<?php echo url_for('proyectos_ultimas_notas')?>" class="<?php echo ($module=='proyectos'?'current':'')?>">proyectos</a></li>
