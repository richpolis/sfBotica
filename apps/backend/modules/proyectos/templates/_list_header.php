...
<?php
$list_categorias=  Doctrine_Core::getTable('CategoriasProyectos')->findAll();
...
{
  var $categorias=$("#proyectos_filters_categoria_id option");
  ...
  /*var $status=$("#proyectos_filters_is_active option");
