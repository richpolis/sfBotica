...
/**
 * proyectos module configuration.
 *
 ...
 */
abstract class BaseProyectosGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%categorias_proyectos%% - %%position%% - %%titulo%% - %%is_active%%';
  }
  ...
  {
    return 'Modificar proyecto "%%titulo%%"';
  }
  ...
  {
    return array(  'Galeria' =>   array(    0 => '_photoUpload',  ),  'Proyecto' =>   array(    0 => 'categoria_id',    1 => 'thumbnail',    2 => 'titulo',    3 => 'contenido',    4 => 'is_active',  ),);
  }

  public function getNewDisplay()
  {
    return array(  'Proyecto' =>   array(    0 => 'categoria_id',    1 => 'thumbnail',    2 => 'titulo',    3 => 'contenido',    4 => 'is_active',  ),);
  }

  public function getListDisplay()
  {
    return array(  0 => 'categorias_proyectos',  1 => 'position',  2 => 'titulo',  3 => 'is_active',);
  }
  ...
  public function getFieldsDefault()
  {
    return array(
      ...
      'categorias_proyectos' => array(  'is_link' => false,  'is_real' => false,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',  'label' => 'Categoria',),
    );
  }
