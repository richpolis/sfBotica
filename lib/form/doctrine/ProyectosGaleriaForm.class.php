 ...
 */
class ProyectosGaleriaForm extends BaseProyectosGaleriaForm
{
  public function configure()
  {
      ...
      if(!$this->isNew()){
        ...
        $tipos=Doctrine_Core::getTable('ProyectosGaleria')->getTiposArchivo();
      ...
      $this->validatorSchema['thumbnail'] = new sfValidatorFile(array(
        ...
        'path' => sfConfig::get('sf_upload_dir').'/publicaciones/thumbnails'
      ));
  }
  ...
  public function setConfigImagen(){
    $this->widgetSchema['archivo'] = new sfWidgetFormInputFileEditable(array(
        'label'     => 'Imagen',
        'file_src'  => '/uploads/publicaciones/'.$this->getObject()->getArchivo(),
        'is_image'  => true,
        'edit_mode' => !$this->isNew(),
        'template'  => '<div><img src="/uploads/publicaciones/'.$this->getObject()->getArchivo().'" style="max-heigth:400px"/><br /><label></label>%input%<br />%delete% %delete_label%<label></label></div>',
    ));
  ...
  public function setConfigLink(){
    $preview=$this->getObject()->getArchivoView(array("width"=>420,"height"=>315));  
    $this->widgetSchema['archivo'] = new sfWidgetFormInputFileEditable(array(
    'label'     => 'Flash',
    'file_src'  => '/uploads/publicaciones/'.$this->getObject()->getArchivo(),
    'is_image'  => false,
