...
/**
 * ProyectosGaleria form base class.
 *
 * @method ProyectosGaleria getObject() Returns the current form's model object
 *
 * @package    Botica
 * @subpackage form
 ...
 */
abstract class BaseProyectosGaleriaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'publicacion_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Proyectos'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('proyectos_galeria[%s]');
