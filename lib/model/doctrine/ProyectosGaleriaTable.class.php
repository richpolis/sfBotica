...
class ProyectosGaleriaTable extends Doctrine_Table
{
    ...
    public function retrieveBackendProyectosList(Doctrine_Query $q)
    {
     $rootAlias = $q->getRootAlias();
     $q->leftJoin($rootAlias . '.ProyectosGaleria c');
     return $q;
    }
