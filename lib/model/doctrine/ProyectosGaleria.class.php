 ...
 */
class ProyectosGaleria extends BaseProyectosGaleria
{
    ...
    public function getArchivoValid(){
        $elsefile='';
        switch($this->getTipoArchivo()){
            case ProyectosGaleriaTable::$tipos_archivos['Link']:
                return $this->getArchivo();
                break;
            case ProyectosGaleriaTable::$tipos_archivos['Imagen']:
                $elsefile='sin_imagen_galeria.jpg';
            case ProyectosGaleriaTable::$tipos_archivos['Video']:
...
EOF
    ...
    public function save(Doctrine_Connection $conn = null) {
        ...
        if(!$this->getPosition()){
            $this->setPosition(Doctrine_Core::getTable('ProyectosGaleria')->getMaximo());
        }
    ...
    public function getArchivoView(array $opciones){
        $respuesta="";
        $tipoarchivo=intval($this->getTipoArchivo());
        $tipos=  Doctrine_Core::getTable('ProyectosGaleria')->getTiposArchivo();
        switch($tipoarchivo){
            case $tipos['Imagen']:
            ...
            case $tipos['Link']:
                ...
                $wVideo=$opciones["width"];
                $hVideo=$opciones["height"];
                $withLayout=0;
