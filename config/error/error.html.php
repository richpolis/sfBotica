...
<html xmlns="http://www.w3.org/1999/xhtml"  class="no-js">
    <head>
        ...
        <meta name="title" content="Botica" />
        <meta name="description" content="Botica" />
        <meta name="keywords" content="Botica" />
    ...
    <body class="home page page-id-5 page-template-default no-handheld webkit webkit-5">
        ...
        <section role="main" id="content" class="container" style="display: block;">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('#background').smartBackgroundResize({
                    image: 'http://botica.interactivevalley.com/uploads/assets/2e24c7c54f5d41e5aefab175fd669f44efd9c21a.jpg'
                });
            });
        </script>
    </body>
